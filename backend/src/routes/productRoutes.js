...
router.post("/", async (req, res) => {
  const { name, img, description, price, stock, digitalProduct, rating, ownerId } = req.body;
  let newProduct = { name, img, description, price, stock, digitalProduct, rating, ownerId };
